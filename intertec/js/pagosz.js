...
async function metodPago() {
  Swal.fire({
    ...
    html: "<div class='col-md-12'><img src='/isie/bbva.png' style='width:400px;height:100px;' onclick='clientPago()'></div><br><div class='col-md-12'><img src='/isie/santander.png' style='width:400px;height:100px;' onclick='clientPagoS()'></div>",
  });
}
        ...
        if (result.isConfirmed) {
          $.ajax({
            ...
            data: {
              ...
              tusu: tus.substr(0,3).toLowerCase(),
              psie: psie,
              dummy: 0,
            },
            success: async function (resp) {
              let folio = await resp.split('src="/intertec/js/flotante.js"></script>');
              orden = folio[1];
              if (orden.length == 10) {
                ...
                formData.append("tusu", tus.substr(0,3).toLowerCase());
